  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-4 py-10 sm:px-6">
      ...
      <section className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-[var(--shadow-soft)]">
        ...
        <Link
          href="/"
          onClick={() => trackEvent("beta_onboarding_open_app_clicked", {})}
          className="mt-5 inline-flex w-full items-center justify-center rounded-2xl bg-[var(--primary)] px-4 py-3 text-sm font-semibold text-white shadow-[var(--shadow-soft)] transition hover:bg-[var(--primary-dark)]"
        >
          Open MunchHSV
        </Link>
      </section>
      ...
      <section className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-[var(--shadow-soft)]">
        ...
        <Link
          href="/"
          onClick={() => trackEvent("beta_onboarding_go_trending_clicked", {})}
